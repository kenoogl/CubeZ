 ...
 * @param [in]     B      RHSベクトル
 * @param [in]     itr_max 最大反復数
 * @param [in]     flop   浮動小数点演算数3
 * @note LSOR_P3から、最終段の直接反転を関数か呼び出しから直接展開へ
 */
 ...
 * @param [in]     itr_max 最大反復数
 * @param [in]     flop   浮動小数点演算数
 * @note LSOR_P4から、一次元配列利用、テンポラリに倍精度
 */
 ...
 * @param [in]     itr_max 最大反復数
 * @param [in]     flop   浮動小数点演算数
 * @note LSOR_P5から、テンポラリを単精度にして変換コストを下げる
 */
