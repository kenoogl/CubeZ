...
macro (AddOptimizeOption)
  ...
  if(TARGET_ARCH STREQUAL "NEC_Aurora_VE")
    ...
    set(CMAKE_Fortran_FLAGS "-fpp -Wall -O3 -proginf -report-all -fdiag-parallel=2 -fdiag-vector=2 -std=f95 -cxxlib -mretain-none")
    # リンクをFortranドライバで行うため、-cxxlibを指定
    # mretainは優先的にLLCに保持する配列を指定するオプション，ここではnone=優先度の指定をしない
