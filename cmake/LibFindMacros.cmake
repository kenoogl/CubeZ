...
function (libfind_pkg_detect PREFIX)
  ...
  # Find library
  libfind_pkg_check_modules(${PREFIX}_PKGUIDEONF ${pkgargs})
  if (pathargs)
    find_path(${PREFIX}_INCLUDE_DIR NAMES ${pathargs} HINTS ${${PREFIX}_PKGUIDEONF_INCLUDE_DIRS})
  endif()
  if (libraryargs)
    find_library(${PREFIX}_LIBRARY NAMES ${libraryargs} HINTS ${${PREFIX}_PKGUIDEONF_LIBRARY_DIRS})
  endif()
endfunction()
